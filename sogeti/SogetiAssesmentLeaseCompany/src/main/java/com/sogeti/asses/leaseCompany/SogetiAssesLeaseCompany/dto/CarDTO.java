...
public class CarDTO {
	...
	@ApiModelProperty(example = "1", dataType = "Long", value = "Car's id", accessMode = AccessMode.READ_ONLY)
	private Long id;
	...
	@ApiModelProperty(example = "10000", dataType = "double", required = true, value = "Car's gross price")
	private double grossPrice;
	
	@ApiModelProperty(example = "1000", dataType = "double", required = true, value = "Car's nett Price")
		private double nettPrice;

	@ApiModelProperty(example = "1000", dataType = "double", required = true, value = "Car's mileage")
	...
	@ApiModelProperty(example = "0.8", dataType = "double", required = true,value = "Contract's interest rate")
	private double interestRate;
	
	@ApiModelProperty(example = "1000", dataType = "double", required = true,value = "Contract's lease rate")
